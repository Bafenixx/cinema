...
<body class="body_sobre_filmes">
  ...
  <img src="../imagens/grinch.jpg" class="filmes" alt="Cartaz do filme O Grinch" width="500px">

  <div class="card bg-transparent" style="width: 31rem;">
    <div class="card-body">
      <p class="card-text">O rabugento Grinch faz de tudo para acabar com o Natal dos cidadãos de Quemlândia.
        Seu plano é roubar das pessoas tudo que tenha ligação com a data,
