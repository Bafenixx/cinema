...
<body class="body_sobre_filmes">
  ...
  <div class="card bg-transparent" style="width: 31rem;">
    <div class="card-body">
      <p class="card-text">Após os eventos traumáticos dos capítulos anteriores, Maya se vê novamente perseguida pelos
        três assassinos mascarados.
        ...
        <br><br>
        Classificação indicativa 18 Anos. Contém drogas lícitas, linguagem imprópria, medo.
      </p>
    </div>
  </div>
