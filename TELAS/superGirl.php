...
<body class="body_sobre_filmes">
  ...
  <div class="card bg-transparent" style="width: 31rem;">
    <div class="card-body">
      <p class="card-text">Em Supergirl, Kara encara o mundo sem rodeios, buscando sempre a verdade enquanto procura por
        sua própria identidade e lugar no mundo. Quando um vilão inesperado surge e parece implacável, Kara Zor-El,
        agora em sua alcunha como Supergirl, fará uma parceria improvável para combater o mal. Uma jornada interestelar
        se inicia, mas sem antes a jovem relutar seu lugar nessa épica batalha por justiça e vingança.
        <br><br>
